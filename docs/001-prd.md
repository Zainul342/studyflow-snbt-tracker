...
> Detail: See [003-database-schema.md](./003-database-schema.md)
...
- "Single-Breath Load" architecture (See [004-data-optimization.md](./004-data-optimization.md))
...
> Full roadmap: See [005-roadmap.md](./005-roadmap.md)

---

## 9. References

- [003-database-schema.md](./003-database-schema.md) - Database schema
- [004-data-optimization.md](./004-data-optimization.md) - Data optimization paths
- [005-roadmap.md](./005-roadmap.md) - Feature evolution
