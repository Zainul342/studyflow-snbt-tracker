                ...
                <div className="flex flex-col h-full font-sans">
                    <div className="space-y-6 py-6">
                                ...
                                {sidebarNavItems.map((item) => (
                                    <Link key={item.href} href={item.href}>
                                        <Button
                                            variant="ghost"
                                            className={cn(
                                                "w-full justify-start gap-3 h-10 px-4 rounded-sm transition-all duration-300 group text-xs font-medium",
                                                pathname === item.href
                                                    ? "bg-[#6B4FFF]/10 text-[#6B4FFF] font-bold border border-[#6B4FFF]/20"
                        ...
                        <div className="px-4">
                            ...
                            <div className="space-y-1">
                                <Link href="/settings">
                                    <Button variant="ghost" className="w-full justify-start gap-3 h-10 px-4 text-zinc-500 hover:text-white hover:bg-white/5 rounded-sm group transition-all text-xs">
                                        <Settings className="h-4 w-4 text-zinc-600 group-hover:text-zinc-300" />
                                        <span>Settings</span>
                                    </Button>
                                </Link>
                                <Button variant="ghost" className="w-full justify-start gap-3 h-10 px-4 text-red-400/70 hover:text-red-400 hover:bg-red-400/5 rounded-sm group transition-all text-xs">
